import { submitBenefitsRequest } from "lib/form"
import { useState, useRef, useCallback } from "react"
import FormField from "./../FormField"
import SubmitButton from "./../SubmitButton"

export default function ModuleBenfitsRequest({ module }) {
    ...
    const handleSubmit = useCallback(
        async (event) => {
            ...
            const request = await submitBenefitsRequest({
            ...
            if (!request || request.error) {
                ...
                setMessage(
                    () => "Du modtager en e-mail indenfor et par minutter",
                )
            }
            setTimeout(() => {
                setMessage(null)
                ...
                <div className="mt-10 site-grid">
                    <form
                        ...
                        <FormField
                            inputClassName="border-black-full border-opacity-20"
                            plandek
                            placeholder="Telefonnummer med landekode (+XXXXXXXXXX)"
                            type="tel"
                            pattern="^\+[0-9]{2}[0-9]{8}"
                            name="phone"
                            label="Telefonnummer"
